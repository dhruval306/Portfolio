...
const Card = tw.div`relative flex flex-col animate-bounce_page bg-white items-center rounded shadow-xl p-4 hover:-translate-y-3 transition duration-200 items-center`
...
const Description = tw.div`bg-white text-black flex-1 p-5 `
const Button = tw.div``
